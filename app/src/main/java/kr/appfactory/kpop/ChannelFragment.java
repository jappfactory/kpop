...
public class ChannelFragment extends Fragment implements AbsListView.OnScrollListener {
    ...
    public void onActivityCreated(@Nullable Bundle b) {
        ...
        String target = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&videoEmbeddable=true&maxResults=10&playlistId="+mParam1 + "&key="+getResources().getString(R.string.gcp_api_key);
        getItem(target);
    }
    ...
    public void onScrollStateChanged(AbsListView absListView, int scrollState) {
        ...
        if (scrollState == AbsListView.OnScrollListener.SCROLL_STATE_IDLE && lastItemVisibleFlag && mLockListView == false) {
            ...
            String target2 = "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet&videoEmbeddable=true&maxResults=10&playlistId="+mParam1 + "&key="+getResources().getString(R.string.gcp_api_key)+"&pageToken="+ nextPageToken;
